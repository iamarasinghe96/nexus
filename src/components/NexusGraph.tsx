...
export default function NexusGraph({
  ...
  useEffect(() => {
    ...
    root.append('text')
      .attr('x', cx * 0.5).attr('y', cy)
      .attr('text-anchor', 'middle')
      .attr('fill', 'rgba(29,158,117,0.08)')
      .attr('font-size', 18).attr('font-family', 'monospace').attr('letter-spacing', 4)
      .attr('pointer-events', 'none')
      .text('WASTE RECOVERY')

    root.append('text')
      .attr('x', cx * 1.5).attr('y', cy)
      .attr('text-anchor', 'middle')
      .attr('fill', 'rgba(55,138,221,0.08)')
      .attr('font-size', 18).attr('font-family', 'monospace').attr('letter-spacing', 4)
      .attr('pointer-events', 'none')
